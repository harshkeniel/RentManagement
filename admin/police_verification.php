                                      ...
                                      <div class="row" id="main-body">
                                        <div class="wrapper">
                                            <section class="form signup">
                                                <header>Police Verification Upload</header>
                                                <form action="#" enctype="multipart/form-data">
                                                    ...
                                                    <div class="field file">
                                                        ...
                                                        <input type="file" name="verification" accept="application/pdf" required>
                                                    </div>
                                            ...
                                            <tbody>
                                                <?php
                                                    ...
                                                    while($row = mysqli_fetch_assoc($sql)){
                                                        ...
                                                        $sql1 = mysqli_query($conn,"SELECT * FROM police_verification WHERE user_id={$row['user_id']}");
                                                        $user = true;
                                                        while($row1 = mysqli_fetch_assoc($sql1)){
                                                            ...
                                                            echo '<tr>
                                                                    ...
                                                                    if(empty($row1['file'])){  
                                                                        ...
                                                                        $file = "../files/".$row['user_id']."/policeVerification/".$row1['file'];
                                                                        echo '<td>'.$fdate.'</td>
                                                                                <td>'.$tdate.'</td>
...
<script src="./js/police_verification.js"></script>
<?php
